...
export default function SportsMassagePage() {
  const schemaMarkup = {
    ...
    "@graph": [
      ...
      {
        "@type": "Service",
        "@id": "https://www.jordanphysiotherapyayrshire.co.uk/services/sports-massage",
        "name": "Sports Massage",
        "description": "Professional sports massage therapy to reduce muscle tension, speed recovery, prevent injury and enhance athletic performance in Kilmarnock and Ayrshire.",
        "provider": {
          "@id": "https://www.jordanphysiotherapyayrshire.co.uk"
        },
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 3,
            "name": "Sports Massage",
            "item": "https://www.jordanphysiotherapyayrshire.co.uk/services/sports-massage"
          }
        ]
      }
    ]
